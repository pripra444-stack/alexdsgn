      ...
      <>
        ...
        >
          ...
          <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-2">
            ...
            >
              <PromptInputAction tooltip="Прикрепить изображение">
                <button
              ...
              <div className="flex items-center">
                ...
                >
                  <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                    ...
                    >
                      <FolderCode
                        className={cn("w-4 h-4", showCanvas ? "text-[#D97757]" : "text-inherit")}
                      />
                    </motion.div>
                  </div>
                  <AnimatePresence>
                    {showCanvas && (
                      <motion.span
                        ...
                        exit={{ width: 0, opacity: 0 }}
                        transition={{ duration: 0.2 }}
                        className="text-xs overflow-hidden whitespace-nowrap text-[#D97757] flex-shrink-0"
                      >
                        Canvas
                      </motion.span>
                    )}
              ...
              <Button
                ...
                className={cn(
                  ...
                  isRecording
                    ...
                    : hasContent
                    ? "bg-[#D97757] hover:bg-[#E08A6F] text-white"
